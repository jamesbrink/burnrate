{
  description = "Tray-first desktop quota and burn-rate monitor for Claude Code, Codex, and OpenRouter.";
      ...
      perSystem =
        ...
        in
        {
          ...
          packages = rec {
            burnrate = pkgs.rustPlatform.buildRustPackage (finalAttrs: {
              ...
              npmDeps = pkgs.fetchNpmDeps {
                ...
                hash = "sha256-UAyCpdywgM2WN4IFFtDhZuL+fWlD/YeUlE/0BRM2x4o=";
              };
          ...
          devshells.default = {
            ...
            motd = ''
              {202}${cargoPackage.name}{reset} — tray-first quota monitor ({bold}${system}{reset})
